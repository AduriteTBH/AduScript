// YouTube Navbar Component in pure AduScript

export fn createNavbar(searchState, onToggleSidebar, onHomeClick) {
  return $adu.html`
      ...
      <div class="yt-nav-center">
        <div class="yt-search-container">
          <input
            ...
            oninput=${(e) -> { searchState.value = e.target.value }}
          />
        ...
        <button class="yt-icon-btn interactive-btn" title="Search with your voice" onclick=${() -> { alert("🎙️ Voice search activated: Speak your query!") }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
